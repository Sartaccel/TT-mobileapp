...
class PostJobApplicationSubmission extends StatefulWidget {
  ...
  @override
  State<PostJobApplicationSubmission> createState() => _PostJobApplicationSubmissionState();
}

class _PostJobApplicationSubmissionState extends State<PostJobApplicationSubmission> {
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Application submitted', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'Lato', color: Color(0xff333333)),),
                      SizedBox(height: 5,),
                      Text('Your application was sent to the recruiter', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, fontFamily: 'Lato', color: Color(0xff333333)),),
                  ],)
          ...
          jobList.length > 0 ?Expanded(
            child: RefreshIndicator(
              ...
              child: ListView.builder(itemCount: jobList.length, itemBuilder: (context, index){
                return jobList[index]['id'] == widget.jobData['id']? Container() : Container(
                  margin: EdgeInsets.symmetric(vertical: 5),
                  padding: EdgeInsets.all(15),
                  decoration: BoxDecoration(
                      border: Border.all(width: 0.2, color: Colors.grey),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Container(width: MediaQuery.of(context).size.width-180 ,child:
  ...
  Future<void> fetchUserDataFromPref() async {
    ...
    setState(() {
      ...
      //print(retrievedUserData?.email);
      jobSearchTerm = (widget.jobData['jobTitle'] ?? '').toString().split(' ')[0];
