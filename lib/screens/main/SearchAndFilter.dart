              ...
              SizedBox(
                ...
                child: Autocomplete<String>(
                  optionsViewBuilder: (context, onSelected, options) {
                    return Padding(
                      padding: const EdgeInsets.only(top: 10), // Gap outside the box
                      child: Align(
                  ...
                  fieldViewBuilder: (context, controller, focusNode, onFieldSubmitted) {
                    ...
                    return TextField(
                      ...
                      onChanged: (value) {
                        ...
                        fetchJobTitles(value); // Trigger API call with debounce
                      },
                            ...
                            ? Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: CircularProgressIndicator(
                                    ...
                                    valueColor: const AlwaysStoppedAnimation<Color>(Color(0xff004C99)),
                                  ),
                                ),
                              )
                            : null,
