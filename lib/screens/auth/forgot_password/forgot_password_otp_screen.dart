...
class _ForgotPasswordOTPScreenState extends State<ForgotPasswordOTPScreen> {
  ...
  Future<void> validateOTP(String receivedOTP) async {
    ...
    final url = Uri.parse(AppConstants.BASE_URL + AppConstants.FORGOT_PASSWORD_OTP_VERIFY);
      ...
      if(response.statusCode == 200){
        ...
        if(statusMessage.toLowerCase().contains('success')){
          ...
          Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (context) => ResetNewPassword(id: id,)),
                 ...
                 /* Container(
                  ...
                  InkWell(
                    ...
                    child: Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('Go back to', style: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.w700),),
                        SizedBox(width: 10,),
                        Text('Login', style: TextStyle(color: Color(0xff004C99), fontSize: 14, fontWeight: FontWeight.w700),),
                      ],
                    ),
                  ),
