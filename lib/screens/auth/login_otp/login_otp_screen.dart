...
class LoginOTPScreen extends StatefulWidget {
  ...
  const LoginOTPScreen({super.key, required this.countryCode, required this.mobileNumber});
...
class _LoginOTPScreenState extends State<LoginOTPScreen> {
  ...
  Future<void> verifyOTP(String otp) async {
    final url = Uri.parse(AppConstants.BASE_URL + AppConstants.VERIFY_LOGIN_OTP);
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned(top: 40,left: 0,child: InkWell(onTap: (){
            Navigator.pop(context);
          },child: Row( mainAxisSize: MainAxisSize.min,children: [ IconButton(icon:  Icon(Icons.arrow_back_ios_new), onPressed: (){Navigator.pop(context);},), Text('Back', style: TextStyle(fontSize: 16),) ],))),
            ...
            child: SingleChildScrollView(
              child: Container( width: MediaQuery.of(context).size.width,
                ...
                child: Column(
                  ...
                  children: [
                    Image.asset('assets/images/tt_logo_resized.png', width: MediaQuery.of(context).size.width, height: 60,),
                    SizedBox(height: 40,),
                    ...
                    SizedBox(height: 40,),
                    Text('We have send an OTP on this number', style: TextStyle(fontSize: 13, fontFamily: 'Lato'),),
                    SizedBox(height: 10,),
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('${widget.countryCode}${widget.mobileNumber}', style: TextStyle(color: Color(0xff2979FF), fontSize: 14),),
                        SizedBox(width: 10,),
                    ...
                    Text('Enter OTP', style: TextStyle(fontFamily: 'Lato', fontSize: 20, fontWeight: FontWeight.bold),),
                    SizedBox(height: 40,),
